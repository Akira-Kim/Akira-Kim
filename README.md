...
🧪 Química e Ciência  
🤖 Educação, Programação e Robótica  
...
Gosto especialmente de transformar problemas reais, ideias matemáticas ou necessidades do cotidiano em **sistemas funcionais, organizados e que possam evoluir**.

---

## 🔬 Ciência, Computação e Educação

Uma das áreas que mais me interessa é a interseção entre **ciência e computação**.

Desenvolvo e estudo projetos envolvendo:
...
Minha formação técnica foi a base para minha trajetória em programação e desenvolvimento de software.

Anteriormente cursei **Ciência da Computação na UFSJ**, experiência que contribuiu para minha formação em programação, algoritmos, estruturas de dados, matemática e fundamentos da computação.
